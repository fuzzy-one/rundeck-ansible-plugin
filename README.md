[![Java CI with Gradle](https://github.com/fuzzy-one/rundeck-ansible-plugin/actions/workflows/gradle.yml/badge.svg)](https://github.com/fuzzy-one/rundeck-ansible-plugin/actions/workflows/gradle.yml)
